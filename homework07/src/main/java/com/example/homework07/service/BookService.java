...
import com.example.homework07.mapper.BookMapper;
...
public class BookService {
    ...
    public BookResponseDto saveBook(BookDto newBook) {
        Author author = authorRepository.findById(newBook.getAuthorId()).orElseThrow(() -> new NotFoundException("Автор не " +
                "обнаружен!"));
        Genre genre =
                genreRepository.findById(newBook.getGenreId()).orElseThrow(() -> new NotFoundException("Жанр не " +
                        "обнаружен!"));
